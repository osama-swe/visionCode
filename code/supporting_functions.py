...
def create_output_images(Rover):
      ...
      cv2.putText(map_add,"Fidelity: "+str(fidelity)+'%', (0, 40), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"Rocks collected: "+str(Rover.samples_found), (0, 55), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      if (Rover.mode == 'forward'):
            cv2.putText(map_add,"Mode: Navigate", (0, 195), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      elif (Rover.mode == 'stop'):
            cv2.putText(map_add,"Mode: Turning back", (0, 195), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      elif (Rover.mode == 'goto_rock'):
            cv2.putText(map_add,"Mode: Go to sample", (0, 195), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
